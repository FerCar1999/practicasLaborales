                ...
                <div class="col s12">
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input id="nombSalo" name="nombSalo" type="text" class="validate">
                            <label for="nombSalo">Nombre del salon:</label>
