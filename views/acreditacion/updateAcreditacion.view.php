<div id="updateAcreditacion" class="modal">
            ...
            <div class="row">
                <div class="col s12">
                    <div class="row">
                        ...
                        <input type="hidden" id="codiAcreUpda" name="codiAcreUpda">
                        <input type="hidden" id="estaAcreUpda" name="estaAcreUpda">
                        <div class="input-field col s12">
                            <i class="material-icons prefix">library_books</i>
                            <input id="nombAcreUpda" name="nombAcreUpda" type="text" class="validate">
                            <label for="nombAcreUpda">Nombre de acreditacion:</label>
