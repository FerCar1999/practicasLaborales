<div id="deleteCurso" class="modal">
    <form id="frmDeleCurso" action="">
        <div class="modal-header red darken-1 white-text">
            <h5 class="mt-none mb-none">Eliminar Curso</h5>
            <i class="material-icons modal-close">close</i>
        </div>
        <div class="modal-content">
            <div class="row">
                <input type="hidden" id="codiCursDele" name="codiCursDele">
