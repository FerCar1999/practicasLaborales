<div id="addProfesion" class="modal modal-fixed-footer">
    <form id="frmAdd" action="" class="add">
        <div class="modal-header green darken-1 white-text">
            <h5 class="mt-none mb-none">Agregar Profesion</h5>
                ...
                <div class="col s12">
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            ...
                            <input id="nombProf" name="nombProf" type="text" class="validate">
                            <label for="nombProf">Nombre de profesion:</label>
