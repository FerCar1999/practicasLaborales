            ...
            <div class="card box-shadow-md mt-none">
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col-md-6 right"><a id="helperx" class="waves-effect waves-green btn-flat btn-small" href="../web/manuales/profesion.pdf" target="_blank"><i class="material-icons">help</i></a></div>
                    </div>
